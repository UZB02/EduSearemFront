    ...
    <div class="mx-auto">
        ...
        <div class="md:p-8 p-4">
              ...
              <div class="bg-gray-50 rounded-lg p-4">
                <div class="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p class="text-lg font-medium text-gray-800">{{ formatDate(student.createdAt) }}</p>
                  </div>
                </div>
              </div>
          ...
          <div class="mt-8 pt-6 border-t border-gray-200">
            <div class="flex flex-wrap gap-3">
              <button @click="openEditModal(student)" class="inline-flex items-center cursor-pointer px-4 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 transition-colors">
                <i class="pi pi-pencil mr-2"></i>
                Tahrirlash
              </button>
              
              <button @click="deleteModalVisible=true" class="inline-flex items-center cursor-pointer px-4 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700 transition-colors">
      ...
      <div class=" rounded-2xl  overflow-hidden">
        <div class="flex justify-between  py-6  border-gray-200">
          ...
          <button @click="addPaymentModalVisible=true" class="inline-flex items-center cursor-pointer px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 transition-colors">
